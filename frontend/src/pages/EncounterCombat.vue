    ...
    setBackground() {
      if (
        ...
        document.querySelector("body").style.backgroundImage =
          "url(http://s3.amazonaws.com/catacombs-game-bucket/assets/images/1-floor-background.png)";
      } else if (
        ...
        document.querySelector("body").style.backgroundImage =
          "url(http://s3.amazonaws.com/catacombs-game-bucket/assets/images/2-floor-background.png)";
      } else if (
        ...
        document.querySelector("body").style.backgroundImage =
          "url(http://s3.amazonaws.com/catacombs-game-bucket/assets/images/3-floor-background.png)";
      }
    },
    userIndex() {
