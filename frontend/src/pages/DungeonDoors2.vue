  ...
  <div class="main bg-cover">
    ...
    <div class="doors flex flex-row justify-around my-20">
      <div class="flex flex-col">
        <img class="door1" src="src/assets/images/2-floor-door-enabled.svg" />
      ...
      <div class="flex flex-col">
        <img class="door2" src="src/assets/images/2-floor-door-locked.svg" />
        <label ref="door2" class="text-xl text-center font-squirk"
          >Door 2</label
        >
      </div>
      <div class="flex flex-col">
        <img class="door3" src="src/assets/images/2-floor-door-locked.svg" />
        <label ref="door3" class="text-xl text-center font-squirk"
          >Door 3</label
        >
      </div>
      <div class="flex flex-col">
        <img class="door4" src="src/assets/images/2-floor-door-locked.svg" />
